...
foreach : T_FOREACH varref T_IN varref block
    ;

while : T_WHILE l_expr block
    ;

repeat : T_REPEAT block T_UNTIL l_expr
  ;

if_stmt : T_IF l_expr T_THEN block else_stmt
  ;

else_stmt : T_ELSE block
             | /* empty */
             ;
